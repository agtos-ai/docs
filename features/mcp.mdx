...
When [dynamic tool selection](#dynamic-tool-selection) is enabled, an additional `discover_tools` meta-tool is registered for searching the tool registry at runtime.
...
<CardGroup cols={2}>
  <Card title="MCP Tools Reference" icon="wrench" href="/api-reference/mcp-tools">
    Complete input/output schemas for all 10 built-in tools.
  </Card>
  <Card title="CLI Reference" icon="terminal" href="/features/cli">
    Manage agtOS from the command line — start, setup, chat, and more.
  </Card>
</CardGroup>

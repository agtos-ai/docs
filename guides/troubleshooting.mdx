...
- `ANTHROPIC_API_KEY` (pay-per-token, `sk-ant-api03-` prefix)
- `ANTHROPIC_AUTH_TOKEN` (Max subscription, `sk-ant-oat01-` prefix)
...
**Fix**:
1. Verify your key format: API keys start with `sk-ant-api03-`, OAuth tokens with `sk-ant-oat01-`

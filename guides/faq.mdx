...
<Accordion title="Can I use OpenAI instead of Claude?">
Yes. agtOS supports both Anthropic (Claude) and OpenAI as cloud providers. Set `AGTOS_CLOUD_PROVIDER=openai` and provide an `OPENAI_API_KEY` to use GPT-4o for cloud inference. Claude remains the default. See [Providers](/configuration/providers) for details.
</Accordion>
